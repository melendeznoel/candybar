...
// openFDADrugEnforcementURL is the openFDA Drug Enforcement (recall) endpoint
// (https://open.fda.gov/apis/drug/enforcement/).
const openFDADrugEnforcementURL = "https://api.fda.gov/drug/enforcement.json"

// FetchRecallsByProductDescription returns openFDA drug enforcement records
...
func FetchRecallsByProductDescription(productDescription string) (*RecallResponse, error) {
	...
	reqURL := openFDADrugEnforcementURL + "?" + query.Encode()
